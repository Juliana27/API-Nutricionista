...
public class NutricionistaController {
	...
	@Autowired
	private CadastroNutricionistaServiceImpl serviceCadastroNutricionista;
	
	@Autowired
	private BuscarNutricionistaPorIdServiceImpl serviceBuscaPorId;;
	...
	public Nutricionista buscarNutricionistaPorId(
			@PathVariable(name = "id", required = true) Long id) throws NutricionistaNotFoundException {
		return serviceBuscaPorId.buscarPorId(id);
	}
	
	@PostMapping(path = "/nutricionista/save")
	public void salvarNuticionista(@RequestBody NutricionistaResource nutricionista) {
		serviceCadastroNutricionista.cadastro(nutricionista);
	}
	...
	public void deleteNutricionista(@PathVariable (name = "id", required = true) Long id) 
		...
		serviceBuscaPorId.deletarPorId(id);
	}
}
